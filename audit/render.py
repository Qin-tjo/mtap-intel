...
def render_audit_log(state: dict, pass_record: dict | None, comp_pass: dict | None = None) -> str:
    ...
    lines.append('  <h3>A.5 · Scope &amp; known limitations</h3>')
...
def main():
    ...
    if LOG_MARKER_START in new_html:
        ...
        log_block = render_audit_log(state, pass_rec, comp_rec)
